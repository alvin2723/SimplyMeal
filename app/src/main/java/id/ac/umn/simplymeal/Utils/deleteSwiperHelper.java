...
public abstract class deleteSwiperHelper extends ItemTouchHelper.SimpleCallback {
    ...
    public deleteSwiperHelper(Context context, RecyclerView recyclerView, int btnWidth){
    ...
    public class deleteButton{
        ...
        public deleteButton(Context context, String text, int textSize, int imageResId, int color,
        ...
        if(actionState == ItemTouchHelper.ACTION_STATE_SWIPE){
            if(dX < 0){
                ...
                if(!buttonBuffer.containsKey(pos)){
                    instanstiateDeleteButton(viewHolder, buffer);
                    buttonBuffer.put(pos, buffer);
                }else{
                    buffer = buttonBuffer.get(pos);
                }
                translationX = dX*buffer.size()*btnWidth/itemView.getWidth();
    ...
    public abstract void instanstiateDeleteButton(RecyclerView.ViewHolder viewHolder,
                                       List<deleteButton> buf);

    private void drawButton(Canvas c, View itemView, List<deleteButton> buffer, int pos, float transitionX) {
