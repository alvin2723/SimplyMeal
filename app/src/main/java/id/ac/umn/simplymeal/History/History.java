...
public class History {
    ...
    public History(String trans_number,String userEmail, String transDate, List<Cart> cartMenu, String totalPrice, ArrayList<String> deliveryDay, String ongkir, String paymentMethod) {
